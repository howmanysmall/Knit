...
-- optimizations and other ways to cheese luau
local FastEvent_Is = FastEvent.Is
local FastEvent_new = FastEvent.new
...
local function HeartbeatStep()
	...
	repeat
		...
		if FastEvent_Is(Function) then
			...
			local BindableEvent = FastEvent_new()
